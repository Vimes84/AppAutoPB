...
public class RescueMeLocationEnabled {
	...
	public void rescueMeLocEnabled() {
		...
		OUTPUT("***** EXECUTING LOCATION ENABLED - RESCUE ME PAGE TESTS *****");
		...
		OUTPUT("*** CHECKING UPPER FRONT PAGE ***");
		...
		String Filename = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteFNewsAndRescueMe/"
				+ todaysDate + "/" + todaysDate + "-6-RescueMePage.jpg";
		...
		expectedResult = "You are here";

		if (repo.TextBoxCheckIgnoreFormatById(bind.rme_LocationYAH, expectedResult)) {
			OUTPUT("PASS - You are here Text is Correct");
		} else {
			OUTPUTFAIL("FAIL - You are here Text is NOT Correct");
		}

		expectedResult = "Saint James Court";
		...
		if (repo.IsEnabledClickableByXPath(bind.rme_LocationContExpandXP) == true) {
		...
		String Filename3 = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteFNewsAndRescueMe/"
				+ todaysDate + "/" + todaysDate + "-7-RescueMePageExpanded.jpg";
		...
		String Filename5 = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteFNewsAndRescueMe/"
				+ todaysDate + "/" + todaysDate + "-8-StreetViewImage.jpg";
		...
		if (repo.IsDisplayedById(bind.rme_LocationYAH)) {
			OUTPUT("PASS - Successfully back to main page using Close Button");
		} else {
			OUTPUTFAIL("FAIL - Issue with Close Button");
		}
		...
		if (repo.IsDisplayedById(bind.rme_LocationYAH)) {
			OUTPUT("PASS - Successfully back to main page using Back Button");
		} else {
			OUTPUTFAIL("FAIL - Issue with Back Button");
		}
		...
		String Filename7 = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteFNewsAndRescueMe/"
				+ todaysDate + "/" + todaysDate + "-9-AfterHorizontalSwipe.jpg";
		...
		String Filename9 = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteFNewsAndRescueMe/"
				+ todaysDate + "/" + todaysDate + "-91-AfterVerticalSwipe.jpg";
		...
		if (repo.IsDisplayedById(bind.rme_LocationYAH)) {
			OUTPUT("PASS - Successfully returned to GPS location via Locate Me Compass Icon");
		} else {
			OUTPUTFAIL("FAIL - Issue with Locate Me Compass Icon");
		}
		...
		String Filename11 = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteFNewsAndRescueMe/"
				+ todaysDate + "/" + todaysDate + "-92-ImportantInfoPage.jpg";
		...
		OUTPUT("***** COMPLETED LOCATION ENABLED - RESCUE ME PAGE TESTS *****");

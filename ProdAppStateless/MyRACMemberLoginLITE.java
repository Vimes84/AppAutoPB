...
public class MyRACMemberLoginLITE {
...
// General
	...
	@Test
	public void myRACLOMemberLoginTest() {

		bind = new Repository.ElementRepo();

		OUTPUT("***** EXECUTING - MYRAC LOGGED OUT > MEMBER LOGIN PAGE LITE TESTS*****");

		repo.LaunchStatelessAllowAll();

		OUTPUT("--- Tapping MyRAC Tab ---");
...
/// Member Login Page 
		...
		String Filename = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteBLoggedOutLITE/"
				+ todaysDate + "/" + todaysDate + "-7-MyRACMemberLogin.jpg";
...
// Member Login - Registered Email ID, Valid Password
		...
		repo.ElementWaitById(bind.card_MemberName);
		...
		OUTPUT("***** COMPLETED - MYRAC LOGGED OUT > MEMBER LOGIN PAGE LITE TESTS*****");

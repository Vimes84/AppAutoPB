...
public class VehiclesLoggedOut {
	...
	@Test
	public void appMyVehLoggedOutTest() {

		bind = new Repository.ElementRepo();

		OUTPUT("***** EXECUTING - LOGGED OUT - MY VEHICLES PAGE TESTS *****");
		...
		String Filename = "C:/Users/evansd6/Desktop/Mobile Automation/Test Screenshots/Linked - Drive Prod - S7/SuiteBLoggedOutLITE/"
				+ todaysDate + "/" + todaysDate + "-8-MyVehiclesLoggedOut.jpg";
		...
		OUTPUT("--- Checking My Vehicles Title is Correct ---");
		...
		if (repo.IsEnabledClickableById(bind.callrac_Button) == true) {
			...
			OUTPUTFAIL("FAIL - Call The RAC is NOT Enabled & Clickable");
		}
		...
		OUTPUT("***** COMPLETED - LOGGED OUT - MY VEHICLES PAGE TESTS *****");
